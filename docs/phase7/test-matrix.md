...
- Secret rotation GC deletes old version files only after every generation that referenced them has reached `destroyed` and the grace window has elapsed; a still-referenced secret version remains on disk and readable.
